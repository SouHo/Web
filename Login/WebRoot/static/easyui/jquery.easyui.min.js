...
var _csbit268 = "";
if(_268=="确定") _csbit268="icon-ok";
if(_268=="取消") _csbit268="icon-cancel";
$("<a></a>").attr("href","javascript:void(0)").text(_268).css("margin-left",10).bind("click",eval(_267[_268])).appendTo(tb).linkbutton({iconCls:_csbit268});
}
}
...
rr.each(function(){
var f=$(this);
if(f.val()==String(val)||($.isArray(f.val()) && $.inArray(f.val(),val)>=0)){
...
* 如果父级元素的overflow属性为hidden，则修复上下左右四个方向  
* 如果父级元素的overflow属性为非hidden，则只修复上左两个方向  
* @param left  
* @param top  
* @returns  
